...
function set_theme(){
	...
	if(theme_hash == 'pink'){
		...
		$('#main-stylesheet').attr({'href': '/stylesheets/vendor/radmin/radmin-pink.css'});
	}  else if (theme_hash == 'green'){
		radmin_current_theme = 'green';
		$('#main-stylesheet').attr({'href': '/stylesheets/vendor/radmin/radmin-green.css'});
	} else {
		radmin_current_theme = 'default';
		$('#main-stylesheet').attr({'href': '/stylesheets/vendor/radmin/radmin.css'});
	}
}
